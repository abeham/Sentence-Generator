...
namespace SentenceGenerator {
  ...
  internal class Scanner {
    ...
    Token NextToken() {
      ...
      int state;
      if (start.ContainsKey(ch)) { state = (int)start[ch]; } else { state = 0; }
      tlen = 0; AddCh();
      ...
      switch (state) {
        ...
        case 1:
          ...
          if (ch == '-' || ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') { AddCh(); goto case 1; } else { t.kind = 1; break; }
        case 2: { t.kind = 2; break; }
        case 3: { t.kind = 3; break; }
        case 4: { t.kind = 4; break; }
        case 5: { t.kind = 5; break; }
        case 6: { t.kind = 6; break; }
        case 7: { t.kind = 7; break; }
